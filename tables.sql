...
(
    ...
    mdpLogin_utilisateur NUMBER(10),
    langueDefaut_utilisateur NUMBER(10),
    idAdresse_utilisateur NUMBER(10),
...
(
    ...
    CONSTRAINT pk_service PRIMARY KEY (id_serviceLangue)
);
...
(
    ...
    validePresta_ordreDeMission BOOLEAN,
