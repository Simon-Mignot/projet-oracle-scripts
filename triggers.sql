DROP SEQUENCE UTILISATEURSequence;
DROP SEQUENCE DISPONIBILITESequence;
DROP SEQUENCE LANGUESequence;
DROP SEQUENCE SERVICESequence;
DROP SEQUENCE TYPESERVICESequence;
DROP SEQUENCE TYPEDEVISESequence;
DROP SEQUENCE RESERVATIONSequence;
DROP SEQUENCE UTILISATEURSequence;
DROP SEQUENCE ORDREDEMISSIONSequence;
DROP SEQUENCE DEVISSequence;
DROP SEQUENCE FACTURESequence;
DROP SEQUENCE DEVISSequence;
DROP SEQUENCE PAIEMENTSequence;
...
CREATE SEQUENCE DISPONIBILITESequence START WITH 1;
CREATE OR REPLACE TRIGGER DISPONIBILITEInsert
  BEFORE INSERT ON DISPONIBILITE FOR EACH ROW
BEGIN
  SELECT DISPONIBILITESequence.NEXTVAL
    INTO :new.id_disponibilite
    FROM DUAL;
END;
/
